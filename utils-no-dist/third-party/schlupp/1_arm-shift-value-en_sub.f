...
c 	=========================
	...
	open(14,file=sortie2,status='old',IOSTAT=iostatus,ERR=778)

	write(*,*) fiche, sortie, xinitial,
     +         xfinal,yi,yf,sec, Bg,r, Rg, a, b, ret
	...
	if ( iostatus .eq. 0) then
		...
		read(11,*,end=1000) (x(i),y(i),i=1,15000)
	endif
c	write(*,*) fiche, sortie, xinitial,
c     +         xfinal,yi,yf,sec, Bg,r, Rg, a, b, ret

 1000 npt1=i-1
	write(*,*) 'Done', i-1, x(i-1), y(i-1)
	b=-40.
	do 77 cpt=1,600
	 b=b+.1
...
c      close(12)
	...
	do 10 i=1,15000
	   ...
	   yy(i)=0.
 10	continue
	read(12,*,end=200) (xx(i),yy(i),i=1,npt1)
 200  npt2=i-1
      close(12)
...
c      return
778   write(*,*) 'Error opening file ', sortie2, iostatus
      return
      end
